...
image.onload = function(){
    atx.drawImage(image,0,0);
}
image.src = "img/jodipan.jpg"
...
var makePixelGrayScale = function (r,g,b,a){
    var y = (0.5*r)+(0.59*g)+(0.11*b);
    return {r:y, g:y, b:y, a:y};
}
function makeGrayScale(){
    var r,g,b,a;
    var imageData = btx.getImageData(0,0,480,360);
...
function makeThreshold(){
    var imageData = dtx.getImageData(0,0,480,360);
    for (var i = 0; i < imageData.data.length; i+=4){
